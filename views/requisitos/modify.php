    ...
    <section>
        ...
        <form action="requisitosController.php" method="POST">
            ...
            <?php foreach($requisitos as $requisito) : ?>
                ...
                <p>Valor Actual: <?=$requisito->descripcion_requisito?></p>
                <p class="pTitulo--Modificar">Modificar Descripción:</p>
                <textarea name="descripcionRequisito" id="descripcionRequisito" cols="200" rows="10"><?=$requisito->descripcion_requisito?></textarea>
